...
public class newCustomerReceptionist extends javax.swing.JFrame {
     ...
     */
    public newCustomerReceptionist() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(newCustomerReceptionist.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new newCustomerReceptionist().setVisible(true);
            }
        });
    }
